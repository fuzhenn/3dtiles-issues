# @maptalks/3dtiles
[![NPM Version](https://img.shields.io/npm/v/@maptalks/3dtiles.svg)](https://github.com/fuzhenn/3dtiles-issues) [![Conventional Changelog](https://img.shields.io/badge/changelog-conventional-brightgreen.svg)](https://github.com/fuzhenn/3dtiles-issues/blob/main/CHANGELOG.md)
...
- [X] [KHR_techiniques_webgl扩展](https://github.com/KhronosGroup/glTF/tree/main/extensions/2.0/Archived/KHR_techniques_webgl) 一个已经废弃的GLTF 2.0自定义shader扩展，但不少历史3dtile数据仍在使用
- [X] CRN图片纹理格式
- [X] KTX2图片纹理格式
- [ ] 3DTiles Next标准
